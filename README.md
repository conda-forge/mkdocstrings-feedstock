...
Once the `conda-forge` channel has been enabled, `mkdocstrings` can be installed with:

```
conda install mkdocstrings
```

It is possible to list all of the versions of `mkdocstrings` available on your platform with:
